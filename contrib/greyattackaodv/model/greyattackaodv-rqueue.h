 ...
 * \brief greyattackaodv Queue Entry
 */
class QueueEntry
{
  public:
...
/**
 * \ingroup greyattackaodv
 * \brief greyattackaodv route request queue
 *
 * Since greyattackaodv is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
  public:
