...
{
    static TypeId tid = TypeId("ns3::greyattackaodv::TypeHeader")
                            .SetParent<Header>()
...
{
    static TypeId tid = TypeId("ns3::greyattackaodv::RreqHeader")
                            .SetParent<Header>()
                            .SetGroupName("greyattackaodv")
...
{
    static TypeId tid = TypeId("ns3::greyattackaodv::RrepHeader")
                            .SetParent<Header>()
                            .SetGroupName("greyattackaodv")
...
{
    static TypeId tid = TypeId("ns3::greyattackaodv::RrepAckHeader")
                            .SetParent<Header>()
                            .SetGroupName("greyattackaodv")
...
{
    static TypeId tid = TypeId("ns3::greyattackaodv::RerrHeader")
                            .SetParent<Header>()
                            .SetGroupName("greyattackaodv")
