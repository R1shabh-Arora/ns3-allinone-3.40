 ...
 *
 * \brief greyattackaodv loopback UDP echo test case
 */
 ...
 *
 * \brief greyattackaodv Loopback test suite
 */
class greyattackaodvLoopbackTestSuite : public TestSuite
{
  public:
    greyattackaodvLoopbackTestSuite()
        : TestSuite("routing-greyattackaodv-loopback", SYSTEM)
    {
        SetDataDir(NS_TEST_SOURCEDIR);
        // UDP Echo loopback test case
        AddTestCase(new LoopbackTestCase(), TestCase::QUICK);
    }
} g_greyattackaodvLoopbackTestSuite; ///< the test suite
